...
syntax varlist, [file(string) levels(string) force en keep] 
...
forvalues j= 2/5 {
	preserve
		...
		local total = r(N)
		if "`en'" == "en" {
			label define divlabel21`j' -99 "Unsuccessful conversion", add modify 
			label define divlabel21`j' -98 "Ambiguous validation, not able to convert", add modify 
		}
		else {
			label define divlabel21`j' -99 "Conversão indisponível", add modify 
		...
		forvalues i = 1/`total' {
			...
			label define divlabel21`j' `value' `"`label'"', add modify    
		}
		qui label save divlabel21`j' using lixo, replace
	restore
	qui do lixo.do
	qui rm lixo.do
}
...
qui replace _cae_str = "0" + _cae_str if inlist(_valid_cae_21, 2, 20, 200, 2000)

/*
if "`fl'" == "fl" {
	qui replace _cae_str = "0" + _cae_str if inlist(_valid_cae_21, 13, 23, 33, 43)
}*/
...
foreach item in `levels' {
	if "`item'" == "1" {
		...
		qui replace _cae_str = "P" if inlist(substr(_cae_str,1,2), "95", "96", "97")
		...
		qui replace rev21_section = -99 if _valid_cae_21 == 200000
		if ("`force'" != "force") qui replace rev21_section = -98 if inlist(_valid_cae_21, 30, 300, 3000)
		if (`zero_dropped' == 0) qui replace rev21_section = -98 if (!missing(_zerosdropped) & !inlist(_valid_cae_`rev',2,10,20,100,200,1000,2000))
		qui replace rev21_section = -99 if `len' < 2 
		label values rev21_section divlabel212
	...
	if "`item'" == "2" {
		...
		qui replace _cae_str = "PP" if inlist(substr(_cae_str,1,2), "95", "96", "97")
		...
		qui replace rev21_subsection = -99 if _valid_cae_21 == 200000
		if ("`force'" != "force") qui replace rev21_subsection = -98 if inlist(_valid_cae_21, 30, 300, 3000)
		if (`zero_dropped' == 0) qui replace rev21_subsection = -98 if (!missing(_zerosdropped) & !inlist(_valid_cae_`rev',2,10,20,100,200,1000,2000))
		qui replace rev21_subsection = -99 if `len' < 2 
		label values rev21_subsection divlabel212
	...
	if "`item'" == "3" {
		...
		qui replace rev21_division = -99 if _valid_cae_21 == 200000
		if ("`force'" != "force") qui replace rev21_division = -98 if inlist(_valid_cae_21, 30, 300, 3000)
		if (`zero_dropped' == 0) qui replace rev21_division = -98 if (!missing(_zerosdropped) & !inlist(_valid_cae_`rev',2,10,20,100,200,1000,2000))
		qui replace rev21_division = -99 if `len' < 2
		label values rev21_division divlabel212
	...
	if "`item'" == "4" {
		...
		qui replace rev21_group = -99 if _valid_cae_21 == 200000
		if ("`force'" != "force") qui replace rev21_group = -98 if inlist(_valid_cae_21, 30, 300, 3000)
		if (`zero_dropped' == 0) qui replace rev21_group = -98 if (!missing(_zerosdropped) & !inlist(_valid_cae_`rev',2,10,20,100,200,1000,2000))
		qui replace rev21_group = -99 if `len' < 3 
		label values rev21_group divlabel213
	...
	if "`item'" == "5" {
		...
		qui replace rev21_class = -99 if _valid_cae_21 == 200000
		if ("`force'" != "force") qui replace rev21_class = -98 if inlist(_valid_cae_21, 30, 300, 3000)
		if (`zero_dropped' == 0) qui replace rev21_class = -98 if (!missing(_zerosdropped) & !inlist(_valid_cae_`rev',2,10,20,100,200,1000,2000))
		qui replace rev21_class = -99 if `len' < 4
		label values rev21_class divlabel214
	...
	if "`item'" == "6" {
		...
		qui replace rev21_subclass = -99 if _valid_cae_21 == 200000
		if ("`force'" != "force") qui replace rev21_subclass = -98 if inlist(_valid_cae_21, 30, 300, 3000)
		if (`zero_dropped' == 0) qui replace rev21_subclass = -98 if (!missing(_zerosdropped) & !inlist(_valid_cae_`rev',2,10,20,100,200,1000,2000))
		qui replace rev21_subclass = -99 if `len' < 5
		label values rev21_subclass divlabel215
