...
{.-}
help for {cmd:metaxl morph} {right:}
{.-}

{title:Title}

{pstd}
{cmd:metaxl morph} {hline 1} transforms a metadata file to eliminate redundant information
...
{pstd}
{opt metaxl morph} is a Stata command that transforms a metadata file by removing 
redundant information. The command assumes that the Excel file has the structure of 
the file produced by {help metaxl_extract:metaxl extract}.
...
of merging other sheets, the sheet {it: variables} (see {help metaxl_extract:metaxl extract}) 
...
{p 8 16}{inp:. metaxl morph (vl_lab1 = vl_lab2 vl_lab3), meta(meta) save(morph)}{p_end}
...
{p 8 16}{inp:. metaxl morph (vl_lab3 = vl_lab1 vl_lab2) (vl_lab6 = vl_lab4 vl_lab5), meta(meta)}{p_end}
...
the structure of the file exported by {help metaxl_extract:metaxl extract}. Also, users 
