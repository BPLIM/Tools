...
{.-}
help for {cmd:metaxl uniform} {right:}
{.-}

{title:Title}

{pstd}
{cmd:metaxl uniform} {hline 1} harmonizes information in metadata files
...
{pstd}
{opt metaxl uniform} is a Stata command that harmonizes metadata stored in an Excel file. 
...
by {help metaxl_combine:metaxl combine}, recoding values that have the same code 
...
{p 8 16}{inp:. metaxl uniform, meta(meta)}{p_end}
...
{p 8 16}{inp:. metaxl uniform, meta(meta) sh(vl_lab1 vl_lab2) new(unif)}{p_end}
